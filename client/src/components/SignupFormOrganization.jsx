...
const SignupFormOrganization = ({ setUIElements, setTimeNotification }) => {
  ...
  return (
    <Form onSubmit={handleSignUpForm} className="flex flex-col gap-4 my-2">
      ...
      <Input
        ...
        required
      ></Input>
      <Input type="name" name="name" label="Name of the Organization" required></Input>
      <Input
        type="tel"
        name="phoneNumber"
        label="Phone Number"
...
export default SignupFormOrganization;
