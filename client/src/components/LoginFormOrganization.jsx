...
const LoginFormOrganization = ({ setUIElements, setTimeNotification }) => {
  ...
  const handleLoginForm = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:3000/api/organizations/login", {
        method: "POST", // POST
      ...
      dispatch(authActions.setEntity({ entity: data.organization, entityType: "Organization" }));
...
export default LoginFormOrganization;
